...
function cfct_choose_content_template_category($type = 'content') {
	$files = cfct_cat_templates($type);
	if (count($files)) {
		foreach ($files as $file) {
...
function cfct_choose_content_template_role($type = 'content') {
	$files = cfct_role_templates($type);
	if (count($files)) {
...
function cfct_choose_content_template_tag($type = 'content') {
	global $post;
	$files = cfct_tag_templates($type);
	if (count($files)) {
